          ...
          <div class="chart-wrapper">
            ...
            <div class="table-wrapper">
              <el-table :data="tableData">
                ...
                <el-table-column prop="count" label="总搜索数" />
      ...
      <el-card shadow="hover">
        <template v-slot:header>
          <div class="title-wrapper">
            <div class="title-rank">分类销售排行</div>
            <div class="radio-wrapper" size="small">
...
export default {
  data () {
    return {
      ...
      searchNumberOption: {},
      tableData: [{
        id: 1, rank: 1, keyword: 1, count: 100, user: 90, range: '90 %'
      }, {
        id: 1, rank: 1, keyword: 1, count: 100, user: 90, range: '90 %'
      }, {
        id: 1, rank: 1, keyword: 1, count: 100, user: 90, range: '90 %'
